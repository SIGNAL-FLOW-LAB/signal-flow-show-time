...
#ifndef SIGNAL_FLOW_SHOW_TIME_SWIFT_H
#define SIGNAL_FLOW_SHOW_TIME_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SIGNAL_FLOW_Show_Time",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC21SIGNAL_FLOW_Show_Time11AppDelegate")
...
SWIFT_CLASS("_TtC21SIGNAL_FLOW_Show_Time17MainFlutterWindow")
